...
function updateOrderDisplay() {
    ...
    const orderSaladElement = document.getElementById('order-salad');
    const orderDrinkElement = document.getElementById('order-drink');
    const orderDessertElement = document.getElementById('order-dessert');
    ...
    if (!hasAnySelection) {
        ...
        orderSaladElement.style.display = 'none';
        orderDrinkElement.style.display = 'none';
        orderDessertElement.style.display = 'none';
        ...
        orderSaladElement.style.display = 'block';
        orderDrinkElement.style.display = 'block';
        orderDessertElement.style.display = 'block';
        ...
        // Обновляем салат/стартер
        if (selectedDishes.salad) {
            orderSaladElement.innerHTML = `
                <h4>Салат/стартер</h4>
        ...
        if (selectedDishes.salad) totalCost += selectedDishes.salad.price;
        if (selectedDishes.drink) totalCost += selectedDishes.drink.price;
        if (selectedDishes.dessert) totalCost += selectedDishes.dessert.price;
